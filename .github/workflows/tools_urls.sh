...
URL_aroma=git+https://github.com/tiborauer/ICA-AROMA
URL_wls=git+https://github.com/jdiedrichsen/rwls
URL_eeglab=git+https://github.com/sccn/eeglab+eeglab2024.2
URL_fieldtrip=git+https://github.com/fieldtrip/fieldtrip